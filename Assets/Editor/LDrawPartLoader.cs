...
public static class LDrawPartLoader
{
    ...
    public static GameObject SpawnPart(LDrawPart part, string partLibraryPath)
    {
        GameObject go = new GameObject(part.partId);

        LDrawMesh ldrawMesh = LoadMeshFromLibrary(part.partId, partLibraryPath);
        if (ldrawMesh != null)
        {
    ...
    private static string FindPartFile(string partId, string partLibraryPath)
    {
    ...
    private static LDrawMesh LoadMeshFromLibrary(string partId, string partLibraryPath)
    {
        ...
        string datPath = FindPartFile(partId, partLibraryPath);
        if (datPath == null)
        {
        ...
        try
        {
            ...
            LDrawMesh ldrawMesh = ParseDatFileToMesh(datPath, partLibraryPath);
